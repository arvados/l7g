...
func MergeLibraries(text string, libraryToMerge *Library, mainLibrary *Library) *Library {
	newLibrary := InitializeLibrary(text, [][md5.Size]byte{libraryToMerge.ID, mainLibrary.ID})
