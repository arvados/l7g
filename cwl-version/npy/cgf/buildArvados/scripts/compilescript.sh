...
g++ -static -o ./dest/band-to-matrix-npy ./src/band-to-matrix-npy.cpp -L$liblocation -lcnpy -I$liblocation 

g++ -static -o ./dest/npy-to-hiq ./src/npy-to-hiq.cpp -L$liblocation -lcnpy -I$liblocation 

g++ -static -o ./dest/process-npy ./src/process-npy.cpp -L$liblocation -lcnpy -I$liblocation

g++ -static -o ./dest/npy-vec-to-hiq-1hot ./src/npy-vec-to-hiq-1hot.cpp -L$liblocation -lcnpy -I$liblocation
